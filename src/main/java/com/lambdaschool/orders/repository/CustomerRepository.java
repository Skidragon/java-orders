...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    @Query(value = "SELECT c.custname, o.ordernum, o.ordamount, o.orddescription FROM customer AS c INNER JOIN orders AS o WHERE custname = o.custcode ORDER BY c.custcode ASC", nativeQuery = true)
